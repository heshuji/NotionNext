...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bookey.cn', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '赣ICP备2023003579号-1', // 备案号 闽ICP备XXXXXXX
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || ER0XI5CWES, // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || 517458862eb5ef17b84ec407020ac7c0, // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY:
    process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || 810216755bdc7dc6667dce411ad26ea5, // 客户端搜索用的KEY
